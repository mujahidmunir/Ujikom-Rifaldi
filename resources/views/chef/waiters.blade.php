    ...
    <div class="row mt-4">
        <div class="col-lg-12">
            <div class="card radius-25">
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-12"><h4 class="mb-5">Order Delivery</h4></div>
                    </div>
                            ...
                            @foreach($orders as $data)
                                <tr>
                                    ...
                                    <td class=" text-center">
                                        <button class="btn btn-primary btn-sm" onclick="Select(3,{{$data->table_id}}, {{$data->menu_id}})"><i class="fa fa-check"></i></button>
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
...
<div class="modal fade" id="Select" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenter" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form action="{{url('chef/order-delivery')}}" method="POST">
                @csrf
